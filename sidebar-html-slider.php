        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <a href="<?php the_field( 'html_link' ); ?>" class="btn-common btn--secondary-outline">
                        <span class="text-green">Get Started</span>
                    </a>
                </div>
                <!-- <div class="col-lg-4">
                    <i class="<?php the_field( 'html_icon1' ); ?>"></i>
                    <i class="<?php the_field( 'html_icon2' ); ?>"></i>
                </div> -->
            </div>
        </div>
        <!-- <div class="down-banner-arrow"></div> -->
    </div>
