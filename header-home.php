    ...
    <header class="ui-header">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <button class="burger-menu not-active" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight">
                    <span></span>
                    <span></span>
                    <span></span>
                </button>
                                ...
                                <li>
                                    <div class="accordion accordion-flush mobile-menu-accordion">
                                        <div class="accordion-item">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne"><a href="/services/">Services</a></button>
